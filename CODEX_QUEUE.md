...
| Tache | Statut | Note |
| --- | --- | --- |
| Hero accueil - image borne bois mariage | Terminé | Visuel hero d'accueil remplacé par `/images/borne-bois-mariage-premium-event-pic.webp`; commit `8e150f8` déployé sur Vercel (`READY`) et alias production vérifié. |
